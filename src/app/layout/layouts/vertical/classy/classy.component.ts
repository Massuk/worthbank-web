...
import { WorthBankNavigationService, WorthBankVerticalNavigationComponent } from '@worthbank/components/navigation';
...
export class ClassyLayoutComponent implements OnInit, OnDestroy
{
    ...
    {
        // Get the navigation
        const navigation = this._worthbankNavigationService.getComponent<WorthBankVerticalNavigationComponent>(name);
