...
export const clients = [
    {
        ...
        name: 'Alvaro Castro',
        email: 'alvarocastro@gmail.com',
        phoneNumbers: [
            {
                country: 'pe',
                phoneNumber: '984 531 468',
            }
        ],
        title: 'Director de Marketing',
        company: 'Airbnb',
        birthday: '1975-01-10T12:00:00.000Z',
        address: 'Av. José Pardo, Miraflores 15074',
        notes: 'A la fecha cuenta con 3 vehiculos adquiridos en nuestra empresa.',
    },
    {
        ...
        background: 'assets/images/cards/14-640x480.jpg',
        name: 'Omar Moya',
        email: 'omarmoya@gmail.com',
        phoneNumbers: [
            {
                country: 'pe',
                phoneNumber: '934 537 380'
            }
        ],
        title: 'Practicante de Ciberseguridad',
        company: 'Interbank',
        birthday: '1994-12-05T12:00:00.000Z',
        address: 'Muy muy lejano (Manchay)',
        notes: 'Recientemente ha estado cotizando diferentes modelos de autos, todos autos del año.',
    },
    {
        ...
        name: 'Ricardo Tello',
        email: 'ricardotello@gmail.com',
        phoneNumbers: [
            {
                country: 'pe',
                phoneNumber: '993 548 262'
            }
        ],
        title: 'Costurero',
        company: 'Textiles Tello',
        birthday: '1988-05-26T12:00:00.000Z',
        address: 'Jr. Parinacochas 4498, La Victoria',
        notes: 'Anteriormente compró un auto mediante plan de pagos en otro banco pero devolvió el auto.',
    },
    {
        ...
        name: 'Julio Quispe',
        email: 'julioquispe@gmail.com',
        phoneNumbers: [
            {
                country: 'pe',
                phoneNumber: '975 142 280',
            },
        ],
        company: null,
        birthday: '1968-08-13T12:00:00.000Z',
        address: 'Av. Canadá 488',
        notes: 'No cuenta con trabajo fijo, revisar historial crediticio.',
    },
    {
        ...
        name: 'Mario Corrales Silva',
        email: 'mariocorrales@gmail.com',
        phoneNumbers: [
            {
                country: 'pe',
                phoneNumber: '964 401 390',
            },
            {
                country: 'pe',
                phoneNumber: '956 546 289',
            }
        ],
        title: 'Profesor',
        company: 'I.E Los Educadores',
        birthday: '1983-12-22T12:00:00.000Z',
        address: 'Av. Metropolitana 583, Santa Anita',
        notes: 'No presenta historial crediticio.',
    },
    {
        ...
        name: 'Marcelo López Tapia',
        email: 'marcelolopez@gmail.com',
        phoneNumbers: [
            {
                country: 'pe',
                phoneNumber: '978 426 374',
            },
        ],
        title: 'Músico',
        company: null,
        birthday: '1963-08-24T12:00:00.000Z',
        address: 'Av. Ejército 477, Miraflores',
        notes: 'Recientemente ha adquirido un departamento financiado con nuestro banco.'
    },
];
