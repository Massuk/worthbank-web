...
import { WorthBankMockApiReplyCallback } from '@worthbank/lib/mock-api/mock-api.types';

export class WorthBankMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: WorthBankMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: WorthBankMockApiReplyCallback): void
    {
        // Store the reply
