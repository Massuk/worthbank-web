...
import { WorthBankAnimationCurves, WorthBankAnimationDurations } from '@worthbank/animations/defaults';
...
const slideInTop = trigger('slideInTop',
    [
        ...
        transition('void => *', animate('{{timings}}'),
            {
                params: {
                    timings: `${WorthBankAnimationDurations.entering} ${WorthBankAnimationCurves.deceleration}`
                }
            }
        )
    ]
...
const slideOutTop = trigger('slideOutTop',
    [
        ...
        transition('* => void', animate('{{timings}}'),
            {
                params: {
                    timings: `${WorthBankAnimationDurations.exiting} ${WorthBankAnimationCurves.acceleration}`
                }
            }
        )
    ]
