...
import { WorthBankHighlightService } from '@worthbank/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[worthbank-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'worthbankHighlight'
})
export class WorthBankHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _worthbankHighlightService: WorthBankHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._worthbankHighlightService.highlight(this.code, this.lang));
