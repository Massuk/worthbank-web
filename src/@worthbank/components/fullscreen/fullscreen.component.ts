...
import { FSDocument, FSDocumentElement } from '@worthbank/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'worthbank-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'worthbankFullscreen'
})
export class WorthBankFullscreenComponent implements OnInit
{
